...
# argument_topic_diversity
[![Arxiv](https://img.shields.io/badge/Arxiv-YYMM.NNNNN-red?style=flat-square&logo=arxiv&logoColor=white)](https://put-here-your-paper.com)
[![License](https://img.shields.io/github/license/UKPLab/argument-topic-diversity)](https://opensource.org/licenses/Apache-2.0)
[![Python Versions](https://img.shields.io/badge/Python-3.9-blue.svg?style=flat&logo=python&logoColor=white)](https://www.python.org/)
[![CI](https://github.com/UKPLab/argument-topic-diversity/actions/workflows/main.yml/badge.svg)](https://github.com/UKPLab/argument-topic-diversity/actions/workflows/main.yml)
...
To import classes/methods of `argument_topic_diversity` from inside the package itself you can use relative imports: 
...
```py
from argument_topic_diversity import BaseClass # Notice how I omit the file name
from argument_topic_diversity.subpackage import SubPackageClass # Here it's necessary because it's a subpackage
...
This is how you can use `argument_topic_diversity` from command line:

```bash
$ python -m argument_topic_diversity
```
